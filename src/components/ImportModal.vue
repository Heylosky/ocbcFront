  ...
  <div class="modal-backdrop">
    <div class="modal">
      <div class="modal-header">
        <h2 style="margin: auto">Import people</h2>
      </div>
      <div class="modal-body">
        <span>Please upload your .csv file in format</span>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn-confirm" @click="saveBtn">SAVE</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    saveBtn() {
      ...
      requestPost('/people/batch/create', formData,  {
        headers: {
