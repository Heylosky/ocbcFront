...
export default {
  ...
  methods: {
    closeSelf() {
      this.$emit("closeGpUnassign");
    },
    saveBtn() {
      let formData = new FormData();
      formData.append('unassignList', this.unassignList)
      formData.append('tags', this.csGp)
      requestPost('/people/tags/unassign', formData,  {
        headers: {
